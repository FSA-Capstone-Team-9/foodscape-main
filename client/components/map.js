...
export default function Map() {
  ...
  useEffect(() => {
    ...
    map.current.on("load", function () {
      ...
      const colors = ["#eb3434", "#eb3434", "#eb9c34", "#e8eb34", "#00ff00"];
      // test layer 1
  ...
  function onButtonChange(clickedLayer) {
    ...
    switch (clickedLayer) {
      case "restaurants-1":
        map.current.setLayoutProperty("restaurants-2", "visibility", "none");
        map.current.setLayoutProperty("restaurants-3", "visibility", "none");
        map.current.setLayoutProperty("restaurant-price", "visibility", "none");
        break;
      case "restaurants-2":
        map.current.setLayoutProperty("restaurants-1", "visibility", "none");
        map.current.setLayoutProperty("restaurants-3", "visibility", "none");
        map.current.setLayoutProperty("restaurant-price", "visibility", "none");
        break;
      case "restaurants-3":
